 ...
 */
public class Blake3Partitioner implements IPartitioner
{
    ...
    public static final Blake3Partitioner instance = new Blake3Partitioner();
    ...
    private long[] getHash(ByteBuffer key) {
        ...
        byte[] hashBytes = Blake3.hash(keyBytes);

        ByteBuffer hashBuffer = ByteBuffer.wrap(hashBytes);
        long hash1 = hashBuffer.getLong();
        long hash2 = hashBuffer.getLong();
    ...
    private final Token.TokenFactory tokenFactory = new Token.TokenFactory()
    {
        ...
        public Token fromString(String string)
        {
            ...
            {
                throw new IllegalArgumentException(String.format("Invalid token for Blake3Partitioner. Got %s but expected a long value (unsigned 8 bytes integer).", string));
            }
        }
    };
